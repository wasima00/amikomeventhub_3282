                ...
                <tbody class="divide-y border-t">
                    ...
                    <tr class="hover:bg-slate-50/50 transition {{ $trx->status == 'Pending' ? 'text-slate-400' : '' }}">
                        ...
                        <td class="px-8 py-6">
                            ...
                            <p class="text-xs {{ $trx->status == 'Success' ? 'text-slate-400' : 'text-slate-300' }} mt-0.5">📱 {{ $trx->customer_phone }}</p>
                        </td>
                        <td class="px-8 py-6">
                        ...
                        <td class="px-8 py-6">
                            ...
                            @elseif($trx->status == 'Expired' || $trx->status == 'expire' || $trx->status == 'cancel' || $trx->status == 'deny')
