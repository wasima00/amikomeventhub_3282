    ...
    <main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-32">
                <img src="{{ $event->poster_path ? asset($event->poster_path) : asset('assets/concert.png') }}" alt="{{ $event->title }}"
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div>
                        ...
                        <h2 class="text-5xl font-black">{{ $event->price > 0 ? 'Rp ' . number_format($event->price, 0, ',', '.') : 'Gratis' }} <span class="text-lg font-medium text-indigo-200">{{ $event->price > 0 ? '/ orang' : '' }}</span></h2>
